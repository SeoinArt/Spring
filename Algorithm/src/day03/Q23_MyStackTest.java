...
public class Q23_MyStackTest {
	...
	public static void main(String[] args) {
		...
		Member m1 = new Member("홍길동",26,168);
		Member m2 = new Member("고길동",26,168);
		Member m3 = new Member("황순원",26,168);
		
		MyStack<Member> sk3 = new MyStack<Member>();
		sk3.push(m1);
		sk3.push(m2);
		sk3.push(m3);
		while(!sk3.isEmpty()) {
