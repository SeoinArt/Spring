	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<form name="prodF" id="prodF" method="POST"  action="prodInput" onsubmit="return check()">
					...
					<table class="table table-condensed table-bordered mt-4">
						...
						<tbody>
							<tr>
								...
								<td width="80%">
									<select name="upCg_code" id="upCg_code" onchange="">
									...
									<span id="selectDcg"> 
										<select name="downCg_code" id="downCg_code" onchange="">
							...
							<tr>
								...
								<td width="80%"><input type="text" name="pcompany" id="pcompany"></td>
							</tr>
							<tr>
							...
							<tr>
								<td>상품이미지</td>
								<td><input type="file" name="pimage"><br> 
							...
							<tr>
								...
								<td width="80%">
									<input type="number" name="pqty" id="pqty">개 
									<span style="color: red"> </span>
								</td>
							</tr>
							<tr>
								<td width="20%"><b>상품정가</b></td>
								<td width="80%"><input type="text" name="price" id="price">원 
									<span style="color: red"> </span>
								</td>
							</tr>
							<tr>
