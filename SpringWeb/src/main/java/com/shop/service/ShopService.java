...
public interface ShopService {
	...
	int updateCartQty(CartVO cartVo);//장바구니 추가 관련
	int editCart(CartVO cartVo);// 장바구니 수정
	List<CartVO> selectCartView(int midx);//특정 회원의 장바구니 목록
	...
	CartVO getCartTotal(int midx_fk);//특정 회원의 장바구니 총액, 총 포인트 구하기
